...
namespace MEFEditor.Plugin
{
    ...
    [InstalledProductRegistration("#110", "#112", "2.0", IconResourceID = 406)]
    ...
    public sealed class PluginPackage : Package
    {
        ...
        protected override void Initialize()
        {
            ...
            if ( null != mcs )
            {
                ...
                CommandID toolwndCommandID = new CommandID(GuidList.guidPluginCmdSet, (int)PkgCmdIDList.IDMEFEditorV2);
